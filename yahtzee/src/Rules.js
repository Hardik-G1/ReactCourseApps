...
class FullHouse extends Rule {
  evalRoll=dice=>{
    return (this.freq(dice).length===2 && (this.freq(dice)[0] === 3 || this.freq(dice)[0]===2)) ? this.score : 0;
  }
}
...
class SmallStraight extends Rule {
  evalRoll=dice=>{
    ...
    return d.size>3 && ((d.has(3) && d.has(4)) && (d.has(1)|| d.has(2)|| d.has(5)|| d.has(6))) ? this.score:0;
  }
}
